  ...
  describe "GET 'index'" do
    ...
    describe "for signed in users" do    
      before(:each) do
        ...
        Factory(:user, :email => "thirduser@example.net")
        30.times do
  ...
  describe "GET 'edit'" do
    ...
    it "should be successful" do
     ...
     it "should have the right title" do 
      ...
      it "should have a link to chage the gravatar" do
       get :edit, :id => @user
   ...
   describe "PUT 'update'" do
     ...
     describe "success" do
       before(:each) do
          @attr = {:name=> "New Name", :email =>"joe@mamas.com", :password=>"barbaz",:password_confirmation=>"barbaz" }
        end
   ...
   describe "follow pages" do
    describe "when not signed in" do
      it "should protect following" do
        get :following, :id => 1
        resonse.should redirect_to(signin_path)
      end
      it "should protect following" do
        get :followers, :id => 1
        resonse.should redirect_to(signin_path)
    ...
    describe "when signed in" do
      ...
      it "should show user folllowers" do
